<template>
  <VueChartJS type="horizontalBar" :options="chart_options" :data="chart_data" v-bind="chartProps()" />
</template>
...
export default {
  ...
  computed: {
    ...
    chart_options(){ return _.set(_.set(this.chartOptions(),'scales.yAxes.0.stacked',true),'scales.xAxes.0.stacked',true) }
  }
}
</script>
